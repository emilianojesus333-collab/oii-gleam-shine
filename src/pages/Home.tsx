...
import { Settings, RotateCcw, X, Brain, Target, Heart, Dumbbell, ChevronRight, Trophy } from "lucide-react";
        ...
        <motion.div
          ...
          <motion.div
            ...
            className="mt-4 sm:mt-6">
              ...
              className="w-full py-4 rounded-xl font-semibold flex items-center justify-center gap-2 shadow-lg shadow-primary/30 transition-all bg-black border-primary opacity-75 text-sidebar-ring">
