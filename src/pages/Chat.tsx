...
import { Send, ArrowLeft, Loader2, MicOff, Volume2, AudioLines, Activity, Clock, Menu } from "lucide-react";
...
const Chat = () => {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-[#0B0F14]">
      ...
      {isTranscribing && (
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="flex items-center justify-center gap-2 text-white/60 pb-2">
      ...
      {/* Bottom input bar — pill style */}
      <div className="px-4 pb-8 pt-3 safe-area-bottom">
        <div className="flex items-center gap-2 rounded-full bg-[#1F2937]/80 border border-white/10 px-4 py-2">
          <input
            type="text"
            value={inputValue}
