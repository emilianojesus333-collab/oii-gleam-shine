...
export const ConsistencyRing = () => {
  ...
  if (ci.loading) {
    return (
      <div style={{ background: "#141414", borderRadius: 16, padding: "20px 16px", border: "1px solid rgba(255,255,255,0.07)" }}>
        <div style={{ height: 14, width: "50%", background: "rgba(255,255,255,0.07)", borderRadius: 6, marginBottom: 16, animation: "pulse 1.5s infinite" }} />
  ...
  const deltaColor = ci.delta > 0 ? "#4ADE80" : ci.delta < 0 ? "#F87171" : "rgba(255,255,255,0.50)";
  ...
  return (
    <div style={{ background: "#141414", borderRadius: 16, padding: "20px 16px", border: "1px solid rgba(255,255,255,0.07)" }}>
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 16 }}>
        ...
        <span style={{ fontSize: 11, color: "rgba(255,255,255,0.30)" }}>{ci.currentMonth.label}</span>
      </div>
      ...
      <div style={{ display: "flex", justifyContent: "center", gap: 24, marginBottom: 14 }}>
        <div style={{ textAlign: "center" }}>
          ...
          <p style={{ fontSize: 11, color: "rgba(255,255,255,0.30)", marginTop: 3 }}>treinos feitos</p>
        </div>
        <div style={{ width: 1, background: "rgba(255,255,255,0.07)" }} />
        <div style={{ textAlign: "center" }}>
          <p style={{ fontSize: 22, fontWeight: 900, color: "rgba(255,255,255,0.50)", lineHeight: 1 }}>{ci.currentMonth.planned}</p>
          <p style={{ fontSize: 11, color: "rgba(255,255,255,0.30)", marginTop: 3 }}>planeados</p>
        </div>
      </div>
