    ...
    <Sheet>
      <SheetTrigger asChild>
        <motion.div
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-orange-500/5 to-amber-500/5 animate-pulse py-[11px] mx-[2px] my-[3px] px-[9px] bg-stone-950 border-stone-950" />
